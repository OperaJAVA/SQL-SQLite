...
class PostDaoFileImpl(private val db: SQLiteDatabase) : PostDao {
    ...
    companion object {
        ...
        CREATE TABLE ${PostColumns.TABLE} (
            ...
            ${PostColumns.COLUMN_WATCH_COUNT} INTEGER NOT NULL DEFAULT 0,
    ...
    object PostColumns {
        ...
        const val COLUMN_WATCH_COUNT = "watchCount"
    ...
    private fun map(cursor: Cursor): Post {
        with(cursor) {
            return Post(
                ...
                watchCount = getInt(getColumnIndexOrThrow(PostColumns.COLUMN_WATCH_COUNT)),
